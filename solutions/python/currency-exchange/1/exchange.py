...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    spread_100 = float(spread/100)
    exchange_rate_after_spread = exchange_rate + exchange_rate*spread_100
    new_bill = budget/exchange_rate_after_spread
    final_value = new_bill//denomination
    return int(final_value*denomination)
