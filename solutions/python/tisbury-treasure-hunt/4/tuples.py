...
def convert_coordinate(coordinate):
    ...
    """
    new_coordinate = tuple(coordinate)
...
def create_record(azara_record, rui_record):
    ...
    """
    compare_records(azara_record,rui_record) == True
...
def clean_up(combined_record_group):
    ...
    """
    cleaned = []
    for loc_1,_,loc_2,need_coordinate,color in combined_record_group:
        cleaned.append(str((loc_1,loc_2,need_coordinate,color)))
    return "\n".join(cleaned) + "\n"